...
export function MySessionsPage() {
  ...
  const { sessions, isLoading, fetchMy } = useSessionStore()
  ...
  return (
    <div>
      ...
      <div className="mb-4">
        <input
          type="search"
          placeholder="Zoeken in mijn sessies en prompts..."
          value={query}
      ...
      {isLoading ? (
        ...
        <EmptyState
          title={hasActiveFilters || query ? 'Geen resultaten' : 'Nog geen sessies van jou'}
          description={
            hasActiveFilters || query
              ? 'Geen sessies gevonden voor deze filters.'
              : 'Log je eerste AI-sessie om te beginnen.'
          }
          action={
            hasActiveFilters || query ? (
              <button
