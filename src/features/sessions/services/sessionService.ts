...
function rowToSession(row: SessionRow): LearningSession {
  return {
    ...
    learningValue: row.learning_value ?? undefined,
    frustrationLevel: row.frustration_level ?? undefined,
    confidenceAfter: row.confidence_after ?? undefined,
...
export const sessionService = {
  async createSession(
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        learning_value: input.learningValue ?? null,
        frustration_level: input.frustrationLevel ?? null,
  ...
  async updateSession(input: UpdateSessionInput): Promise<LearningSession> {
    ...
    const updateData: Database['public']['Tables']['sessions']['Update'] = {
      ...
      ...(fields.learningValue !== undefined && { learning_value: fields.learningValue }),
      ...(fields.frustrationLevel !== undefined && { frustration_level: fields.frustrationLevel }),
      ...(fields.confidenceAfter !== undefined && { confidence_after: fields.confidenceAfter }),
