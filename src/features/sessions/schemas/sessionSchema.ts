...
export const SessionSchema = z.object({
  ...
  // Prompt velden
  promptGoal: z.string().max(2000, 'Maximaal 2.000 tekens').optional(),
  systemPrompt: z.string().max(50000, 'Maximaal 50.000 tekens').optional(),
  userPrompt: z.string().max(50000, 'Maximaal 50.000 tekens').optional(),
  promptOutput: z.string().max(50000, 'Maximaal 50.000 tekens').optional(),
  improvedPrompt: z.string().max(50000, 'Maximaal 50.000 tekens').optional(),
